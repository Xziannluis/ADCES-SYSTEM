...
<nav class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <?php if($_SESSION['role'] == 'edp'): ?>
            ...
            <li><a href="../edp/form_settings.php" class="nav-link"><i class="fas fa-file-alt"></i> Form Settings</a></li>
        ...
        <?php if ($_SESSION['role'] === 'teacher'): ?>
            ...
            <li><a href="../teachers/observation_plan.php" class="nav-link"><i class="fas fa-clipboard-list"></i> My Evaluation Schedule</a></li>
