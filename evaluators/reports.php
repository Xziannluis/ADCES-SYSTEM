...
$report_department = '';
$evaluationsStmt = $evaluation->getEvaluationsForReport($scoped_evaluator_id, $academic_year, $semester, $teacher_id, $report_department, $_SESSION['user_id'], $raw_department);
...
<body>
    ...
    function openEvalForm(evalId) {
        window.open('print_evaluation_form.php?id=' + evalId + '&auto_print=1', '_blank');
    }
    </script>
    </div>
</body>
