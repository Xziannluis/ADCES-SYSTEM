...
// For deans/principals, don't restrict by department — they should see their own department
// AND any cross-department evaluations they personally conducted
$report_department = '';
$evaluationsStmt = $evaluation->getEvaluationsForReport($scoped_evaluator_id, $academic_year, $semester, $teacher_id, $report_department, $_SESSION['user_id'], $raw_department, $form_type_filter);
...
$stats = $evaluation->getDepartmentStats($_SESSION['department'], $academic_year, $semester, $_SESSION['user_id']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="modal-dialog" style="max-width:900px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="evalFormStep2" style="<?php echo (($_SESSION['department'] ?? '') !== 'JHS') ? '' : 'display:none;'; ?>">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <?php endif; ?>
                            <span class="fw-bold" id="evalFormTypeLabel"><?php echo (($_SESSION['department'] ?? '') !== 'JHS') ? '<i class="fas fa-file-alt me-1"></i> ISO Form Evaluations' : ''; ?></span>
                        </div>
                        <div class="mb-3">
