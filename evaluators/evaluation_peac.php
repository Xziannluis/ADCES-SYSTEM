                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" style="line-height:1.8;">
                            ...
                            <div class="d-flex flex-wrap gap-4">
                                ...
                                <div>Grade Level/Section: <input type="text" name="grade_level_section" class="border-0 border-bottom" style="outline:none; font-weight:bold; width:150px;" placeholder="e.g., 7-St. Anne"></div>
                            </div>
                            <div class="d-flex flex-wrap gap-4">
