    ...
    <div class="main-content" style="padding:0;">
        ...
        <div class="dashboard-topbar">
            ...
            <div class="ms-auto d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    <button class="btn user-menu-btn dropdown-toggle" type="button" id="subjectCoordinatorMenu" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-user-circle me-1"></i> <?php echo htmlspecialchars($_SESSION['name']); ?> (Subject Coordinator)
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="subjectCoordinatorMenu">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-muted small">
                                                    ...
                                                    <?php if(!empty($assignment['subject'])): ?>
                                                        &bull; <?php echo htmlspecialchars($assignment['subject']); ?>
                                                    <?php endif; ?>
                                                    <?php if(!empty($assignment['grade_level'])): ?>
                                                        &bull; Grade <?php echo htmlspecialchars($assignment['grade_level']); ?>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
