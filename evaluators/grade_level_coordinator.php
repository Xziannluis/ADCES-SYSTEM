...
// Only allow grade level coordinator
if($_SESSION['role'] !== 'grade_level_coordinator') {
...
$assigned_list_query = "SELECT ta.subject, ta.grade_level, t.name, t.department
    ...
    ORDER BY ta.grade_level, t.name";
...
<head>
    ...
    <title>Grade Level Coordinator Dashboard - <?php echo htmlspecialchars($_SESSION['department']); ?></title>
                ...
                <div class="col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                <p class="text-muted mb-0">No assigned teachers found yet.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
