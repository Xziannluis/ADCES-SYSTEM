<?php
$content = file_get_contents(__DIR__ . '/dev/original_teacher_pw.php');
// The file might be UTF-16LE, let's just strip everything and recreate from my known good PHP code from earlier.
$phpcode = <<<'EOF'
<?php
session_start();
...
EOF;
file_put_contents(__DIR__ . '/teachers/change-password.php', $phpcode);
