...
// Hide the upcoming schedule row if evaluations already exist for this semester
// (the schedule has been fulfilled — completed evaluations cover it)
if ($show_upcoming && count($evaluations) > 0) {
    $show_upcoming = false;
}
