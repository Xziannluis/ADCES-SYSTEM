...
// Hide the upcoming schedule row if evaluations already exist AND teacher hasn't signed it
// (keep showing it if signed, to preserve the acknowledgment record)
if ($show_upcoming && count($evaluations) > 0 && !isset($signed_map['upcoming'])) {
    $show_upcoming = false;
}
                            ...
                            <tr>
                                ...
                                <td style="font-size:0.85rem;">
                                    <?php foreach ($all_observer_names as $i => $obs_name): ?>
                                        ...
                                        <?php if (isset($completed_observers[$obs_name])): ?>
                                            <span class="badge bg-success ms-1" style="font-size:0.65rem;">Completed</span>
                                        <?php endif; ?>
