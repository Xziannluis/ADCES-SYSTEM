                        ...
                        <table class="report-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $schedule_text = htmlspecialchars($all_evaluations[0]['subject_observed']);
                                        
                                        // Add time if available
                                        if (!empty($all_evaluations[0]['observation_start_time']) && !empty($all_evaluations[0]['observation_end_time'])) {
                                            $start_time = date('g:i A', strtotime($all_evaluations[0]['observation_start_time']));
                                            $end_time = date('g:i A', strtotime($all_evaluations[0]['observation_end_time']));
                                            $schedule_text .= ' (' . $start_time . ' - ' . $end_time . ')';
                                        } elseif (!empty($all_evaluations[0]['observation_time'])) {
                                            $time = date('g:i A', strtotime($all_evaluations[0]['observation_time']));
                                            $schedule_text .= ' (' . $time . ')';
                                        }
