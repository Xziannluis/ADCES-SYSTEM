...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .avg-row { font-weight: 700; font-size: 10px; margin: 2px 0 2px; text-align: left; padding-left: 20px; }
        .avg-row .avg-line { display: inline-block; width: 80px; border-bottom: 1px solid #000; text-align: center; margin: 0 4px; }

        /* Total average + interpretation */
        .total-avg-row { font-weight: 700; font-size: 10px; margin: 2px 0 1px; text-align: left; padding-left: 20px; }
        .total-avg-row .avg-line { display: inline-block; width: 80px; border-bottom: 1px solid #000; text-align: center; margin: 0 4px; }
