...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sig-name-container { position: relative; border-top: 1px solid #000; height: 40px; display: flex; align-items: center; justify-content: center; }
        .sig-name-container .sig-name { font-weight: 700; font-size: 10.5px; position: relative; z-index: 1; }
        .sig-img { position: absolute; top: -15px; left: 50%; transform: translateX(-50%); z-index: 2; }
        .sig-img img { max-height: 46px; max-width: 100%; object-fit: contain; }
        .sig-caption { text-align: center; font-size: 8.5px; color: #333; margin-top: 2px; }
...
<div class="sig-section">
    ...
    <div class="sig-row">
        ...
        <div class="sig-col">
            <div style="height: 20px; text-align: center; font-weight: 600;"><?php echo h($eval['rater_date'] ?? ''); ?></div>
    ...
    <div class="sig-row">
        ...
        <div class="sig-col">
            <div style="height: 20px; text-align: center; font-weight: 600;"><?php echo h($eval['faculty_date'] ?? ''); ?></div>
