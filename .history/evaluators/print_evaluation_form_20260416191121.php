...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sig-section h6 { font-size: 11px; font-weight: 700; margin: 0 0 2px; background-color: #1a237e; color: #fff; padding: 4px 8px; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
<div class="sig-section">
    ...
    <div class="sig-row">
        ...
        <div class="sig-col">
            <div style="height: 50px; display: flex; align-items: flex-end; justify-content: center; font-weight: 600; font-size: 10px;"><?php echo h($eval['rater_date'] ?? ''); ?></div>
    ...
    <div class="sig-row">
        ...
        <div class="sig-col">
            <div style="height: 50px; display: flex; align-items: flex-end; justify-content: center; font-weight: 600; font-size: 10px;"><?php echo h($eval['faculty_date'] ?? ''); ?></div>
            <div class="sig-line"></div>
            <div class="sig-caption">Date</div>
        </div>
    </div>
