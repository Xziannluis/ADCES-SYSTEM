...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .total-avg-row { font-weight: 700; font-size: 10px; margin: 2px 0 4px; border: 1px solid #000; padding: 4px 8px; text-align: center; }
        .total-avg-row .avg-line { display: inline-block; width: 100px; border-bottom: 1px solid #000; text-align: center; margin-left: 4px; }
            .total-avg-row { text-align: left; padding-left: 10px; margin: 8px 0; }
            .total-box { display: inline-block; border: 1px solid #000; padding: 6px 12px; font-weight: 700; }
            .total-box .avg-label { margin-right: 8px; }
