...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .total-avg-table { width: 100%; border-collapse: collapse; margin: 4px 0; border: 1px solid #000; }
        .total-avg-table td { padding: 6px 10px; font-weight: 700; font-size: 10px; text-align: left; }
