...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Average row inline */
        .avg-row-inline { border: 1px solid #000; border-top: none; padding: 2px 8px; font-size: 10px; text-align: left; padding-left: 20px; }
        .avg-row-inline .avg-line { display: inline-block; width: 80px; border-bottom: 1px solid #000; text-align: center; margin: 0 4px; font-weight: 700; }
