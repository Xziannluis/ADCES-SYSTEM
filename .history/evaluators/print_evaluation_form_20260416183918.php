...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .avg-row td { border: none; border-top: 2px solid #000; padding: 3px 6px; font-weight: 700; font-size: 10px; text-align: center; }
        .avg-row td:first-child { border-left: 1.5px solid #000; }
        .avg-row td:last-child { border-right: 1.5px solid #000; }
