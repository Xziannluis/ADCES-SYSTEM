...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .eval-table .avg-row td { padding: 3px 6px; font-weight: 700; font-size: 10px; border: none !important; border-top: 1px solid #000 !important; text-align: center; }
        .eval-table .avg-row td:first-child { padding: 3px 6px; border-left: 1.5px solid #000 !important; border-top: 1px solid #000 !important; text-align: left; }
        .eval-table .avg-row td:last-child { padding: 3px 6px; border-right: 1.5px solid #000 !important; border-top: 1px solid #000 !important; }
