...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .eval-table .avg-row { border-collapse: collapse; }
        .eval-table .avg-row td { padding: 3px 6px; font-weight: 700; font-size: 10px; border-left: 1px solid #fff !important; border-right: 1px solid #fff !important; border-top: 1px solid #000 !important; border-bottom: none !important; text-align: center; }
        .eval-table .avg-row td:first-child { border-left: 1.5px solid #000 !important; text-align: left; }
