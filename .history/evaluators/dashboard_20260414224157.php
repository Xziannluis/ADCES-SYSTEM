...
iv class="card mb-3">
                        ...
                        <i class="fas fa-user-plus me-1"></i>Manage
                            ...
                            <div class="card-body">
                                <?php if(!empty($assigned_coordinators)):                        <d                        <div>Completed Evaluations</div>
iv class="card mb-3">
                                              <div><?php echo $is_leader ? 'Total Teachers' : 'Department Teachers'; ?></div>
rs-list">
                                        <?php foreach($assigned_coordinators as $coord): ?>
                                            <li class="list-group-item">
                                                ...
                                                <div class="coo                       <d                        <div>Completed Evaluations</div>
iv class="card mb-3">
                                              <div><?php echo $is_leader ? 'Total Teachers' : 'Department Teachers'; ?></div>
rsg><?php echo htmlspecialchars($coord['name']); ?></strong>
