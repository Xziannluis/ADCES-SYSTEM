...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .avg-row { display: inline-block; border: 1px solid #000; padding: 4px 8px; font-weight: 700; font-size: 10px; margin: 2px 0 6px; }
        .avg-row .avg-line { display: inline-block; width: 80px; border-bottom: 1px solid #000; text-align: center; margin-left: 8px; }

        /* Total average + interpretation */
        .total-avg-row { display: inline-block; border: 1.5px solid #000; padding: 6px 10px; font-weight: 700; font-size: 10px; margin: 4px 0 6px; }
        .total-avg-row .avg-line { display: inline-block; width: 100px; border-bottom: 1px solid #000; text-align: center; margin-left: 10px; }
