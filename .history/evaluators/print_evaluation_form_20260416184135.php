...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .avg-row td { padding: 3px 6px; font-weight: 700; font-size: 10px; border: none; }
        .avg-row td.avg-label { border-top: 1px solid #000; border-left: 1.5px solid #000; text-align: left; width: auto; }
        .avg-row td.avg-value { border-top: 1px solid #000; text-align: center; }
        .avg-row td.avg-end { border-top: 1px solid #000; border-right: 1.5px solid #000; }
