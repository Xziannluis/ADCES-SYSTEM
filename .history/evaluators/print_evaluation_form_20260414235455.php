...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sig-line { border-top: 1px solid #000; text-align: center; padding-top: 2px; font-weight: 600; font-size: 10px; position: relative; margin-top: -15px; }
...
<div class="sig-section">
    ...
    <div class="sig-row">
        <div class="sig-col">
            ...
            <div class="sig-line" style="margin-top: -15px;"><?php echo h($raterPrinted ?: ''); ?></div>
    ...
    <div class="sig-row">
        <div class="sig-col">
            <div class="sig-line"></div>
            <div class="sig-line" style="margin-top: -15px;"><?php echo h($facultyPrinted ?: ''); ?></div>
            <div class="sig-img" style="margin-top: -35px;">
