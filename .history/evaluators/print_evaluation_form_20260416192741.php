...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sig-name { text-align: center; font-weight: 600; font-size: 10px; margin-top: -14px; position: relative; z-index: 1; }
        .sig-line { border-top: 1px solid #000; text-align: center; padding-top: 0; font-weight: 600; font-size: 10px; width: 120px; margin: 0 auto; margin-top: 8px; }
