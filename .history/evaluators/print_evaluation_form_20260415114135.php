...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .avg-row { text-align: center; font-weight: 700; font-size: 10px; margin: 1px 0 6px; }
        /* Boxed inline average for each domain */
        ...
        .total-avg-box { border: 1px solid #000; padding: 8px; box-sizing: border-box; width: 100%; }
        .total-avg-box .total-label { font-weight: 700; margin-right: 8px; }
        .total-avg-box .total-value { display: inline-block; min-width: 100px; border-bottom: 1px solid #000; text-align: center; padding-bottom: 2px; }
...
<!-- Total Average + Interpretation -->
<div class="total-avg-row"><span class="total-box"><span class="avg-label">Total Average:</span> <span class="avg-line"><?php echo number_format($overallAvg, 1); ?></span></span></div>
