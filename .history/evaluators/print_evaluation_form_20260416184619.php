...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .eval-table .avg-row td { padding: 3px 6px; font-weight: 700; font-size: 10px; border: none; }
        .eval-table .avg-row td.avg-label { border-top: 1px solid #000; border-left: 1.5px solid #000; text-align: left; width: 18px; }
        .eval-table .avg-row td.avg-value { border-top: 1px solid #000; text-align: center; }
        .eval-table .avg-row td.avg-end { border-top: 1px solid #000; border-right: 1.5px solid #000; }
...
<table class="eval-table">
    ...
    <?php endforeach; ?>
    <tr class="avg-row">
        <td class="num avg-label">Average:</td>
        <td class="avg-value"><span class="avg-line"><?php echo number_format($domain['avg'], 1); ?></span></td>
        <td class="avg-value"></td>
        <td class="avg-value"></td>
        <td class="avg-value"></td>
        <td class="avg-value"></td>
        <td class="avg-value"></td>
