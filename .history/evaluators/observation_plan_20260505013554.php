    ...
    if (!empty($teacher_id)) {
        ...
        if ($eval_id) {
            ...
            try {
                ...
                @file_put_contents(__DIR__ . '/schedule_debug.log', date('c') . " UPDATE teacher_id={$teacher_id} eval_id={$eval_id} ay={$academic_year_for_insert} sem=" . ($post_semester ?: $filter_semester) . " affected={$upd_count} schedule=" . (string)$schedule . PHP_EOL, FILE_APPEND | LOCK_EX);
            } catch (Exception $e) {}
        } else {
            ...
            try {
                ...
                @file_put_contents(__DIR__ . '/schedule_debug.log', date('c') . " INSERT teacher_id={$teacher_id} eval_id={$eval_id} ay={$academic_year_for_insert} sem=" . ($post_semester ?: $filter_semester) . " schedule=" . (string)$schedule . PHP_EOL, FILE_APPEND | LOCK_EX);
            } catch (Exception $e) {}
        }
