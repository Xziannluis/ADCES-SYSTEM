...
foreach ($scheduled_teachers as $t) {
    ...
    $existing_eval_date = !empty($existing_eval_date) ? date('Y-m-d', strtotime($existing_eval_date)) : '';
    ...
    if (!empty($sched_dt)) {
        $ts = strtotime($sched_dt);
        $schedule_data[$row_key]['day_time'] = date('D', $ts) . "\n" . date('g:ia', $ts);
    }

    // Observers: use owning department (the dept that set the schedule)
    // For scheduled teachers: scheduled_department -> teacher's primary department
    $owning_dept = $t['scheduled_department'] ?? ($t['teacher_department'] ?? '');
                ...
                <form method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" id="modal_evaluation_schedule_end" name="evaluation_schedule_end" required>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    <div class="input-group">
                                        ...
                                        <input type="time" class="form-control" id="modal_evaluation_end_time" step="900" required>
                                    </div>
                                </div>
                            </div>
                        </div>
