...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sig-line { border-top: 1px solid #000; text-align: center; padding-top: 2px; font-weight: 600; font-size: 10px; width: 100%; }
...
<div class="sig-section">
    ...
    <div class="sig-row">
        <div class="sig-col">
            ...
            <div class="sig-line"></div>
            <div style="text-align: center; font-weight: 600; font-size: 10px; margin-top: 2px;"><?php echo h($facultyPrinted ?: ''); ?></div>
