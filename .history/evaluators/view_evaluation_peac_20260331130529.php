...
// Allow evaluator-style roles, leaders, and teachers to view an evaluation
            ...
            <div class="card-header">
                <div class="row mb-2 no-print">
                    ...
                    <div class="col-6 text-end">
                        <a href="print_evaluation_form_peac.php?id=<?php echo $evaluationId; ?>&auto_print=1" target="_blank" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                <div class="mb-3" style="line-height:1.8;">
                    ...
                    <div class="d-flex flex-wrap gap-4">
                        ...
                        <div>Grade Level/Section: <strong><u><?php echo h($eval['subject_area'] ?? '—'); ?></u></strong></div>
                    </div>
                    <div class="d-flex flex-wrap gap-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="border rounded">
                            ...
                            <div class="p-2">
                                <textarea class="form-control border-0" rows="4" style="resize:none;" disabled><?php echo h($eval['strengths'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border rounded">
                            ...
                            <div class="p-2">
                                <textarea class="form-control border-0" rows="4" style="resize:none;" disabled><?php echo h($eval['improvement_areas'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="border rounded">
                            ...
                            <div class="p-2">
                                <textarea class="form-control border-0" rows="3" style="resize:none;" disabled><?php echo h($eval['recommendations'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border rounded">
                            ...
                            <div class="p-2">
                                <textarea class="form-control border-0" rows="3" style="resize:none;" disabled><?php echo h($eval['agreement'] ?? ''); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if ($raterSig !== '' && strpos($raterSig, 'data:image/') === 0): ?>
                                    <div class="border rounded p-2 bg-white">
                                        <img src="<?php echo h($raterSig); ?>" alt="Rater signature" style="max-width: 100%; height: 60px; object-fit: contain;" />
                                    </div>
                                <?php else: ?>
                                ...
                                ?>
                                <input type="text" class="form-control mt-2" value="<?php echo h($raterPrinted !== '' ? $raterPrinted : '—'); ?>" disabled>
                            </div>
                            <div class="mt-auto">
                        ...
                        <div class="border p-3 w-100 d-flex flex-column">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if ($facultySig !== '' && strpos($facultySig, 'data:image/') === 0): ?>
                                    <div class="border rounded p-2 bg-white">
                                        <img src="<?php echo h($facultySig); ?>" alt="Faculty signature" style="max-width: 100%; height: 60px; object-fit: contain;" />
                                    </div>
                                <?php else: ?>
                                ...
                                ?>
                                <input type="text" class="form-control mt-2" value="<?php echo h($facultyPrinted !== '' ? $facultyPrinted : '—'); ?>" disabled>
                            </div>
                            <div class="mt-auto">
                                <label class="form-label">Date</label>
