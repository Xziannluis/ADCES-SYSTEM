...
// Leaders (President, Vice President) use the evaluators area
if(!$is_controller_endpoint && in_array($user_role, ['president', 'vice_president']) && strpos($_SERVER['REQUEST_URI'], '/evaluators/') === false) {
