                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="no-print text-center" style="white-space:nowrap; vertical-align:top;">
                                        <a href="../evaluators/<?php echo (($evaluation['evaluation_form_type'] ?? 'iso') === 'peac') ? 'view_evaluation_peac.php' : 'view_evaluation.php'; ?>?id=<?php echo (int)$_GET['eval_id']; ?>" class="btn btn-sm btn-info me-1">
                                            <i class="fas fa-eye me-1"></i> View
                                        </a>
                                        <a href="../evaluators/<?php echo (($evaluation['evaluation_form_type'] ?? 'iso') === 'peac') ? 'print_evaluation_form_peac.php' : 'print_evaluation_form.php'; ?>?id=<?php echo (int)$_GET['eval_id']; ?>&auto_print=1" target="_blank" class="btn btn-sm btn-primary">
