<?php
// Redirect to evaluators/observation_plan.php (consolidated)
...
// Fixed department list for president/VP
...
foreach ($eval_teachers as $t) {
    ...
    if (!empty($sched_dt)) {
        ...
        $schedule_data[$tid]['day_time'] = date('l', strtotime($obs_date));
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        if (!empty($faculty_sig)): ?>
                                            <img src="<?php echo htmlspecialchars($faculty_sig); ?>" alt="Teacher Signature" style="max-height: 40px; max-width: 80px;">
                                        <?php endif; ?>
                                    </td>
